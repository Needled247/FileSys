                    ...
                    <div class="box-content">
                        <div class="control-group">
                            <div class="controls">
                                ...
                                <div class="input-append">
                                    精确查询：
                                    <input placeholder="文件名称" type="text" id="fileName" style="width: 20%">
                                    <button class="btn" type="button" onclick="SearchFileByName()">查询</button>
                                </div>
                            </div>
                        </div>
...
<!--ajax读取-->
<script src="js/UserSearchFile.js"></script>
