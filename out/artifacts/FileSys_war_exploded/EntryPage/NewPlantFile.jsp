            ...
            <div class="row-fluid sortable ui-sortable">
                <div class="box span12" style="">
                    ...
                    <div class="box-content">
                        <form class="form-horizontal" action="CreatePFileAction.action" id="newFileForm" enctype="multipart/form-data" method="post">
                            <fieldset>
...
<!--验证-->
<script src="js/NewFileValidate.js"></script>
