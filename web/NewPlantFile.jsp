            ...
            <div class="row-fluid sortable ui-sortable">
                <div class="box span12" style="">
                    ...
                    <div class="box-content">
                        <form class="form-horizontal" action="CreateFileAction.action" id="newFileForm" enctype="multipart/form-data" method="post">
                            <fieldset>
                                <legend>发布新文件（厂发）</legend>
...
<!--验证-->
<script src="js/fileSys/NewFileValidate.js"></script>
