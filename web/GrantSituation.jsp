                        ...
                        <div class="control-group">
                            <div class="controls">
                                <div class="input-append">
                                    发文状态：
                                    <button class="btn" type="button" onclick="alreadyRelease()">已发布</button>
                                    <button class="btn" type="button" onclick="notRelease()">未发布</button>
                                </div>
                            </div>
                        </div>
...
<!--ajax读取-->
<script src="js/fileSys/GrantSituation.js"></script>
