                    ...
                    <div class="box-content">
                        <div class="control-group">
                            <div class="controls">
                                ...
                                <div class="input-append">
                                    起始时间：
                                    <input placeholder="点击选择..." type="text" id="from" style="width: 10%">
                                    结束时间：
                                    <input placeholder="点击选择..." type="text" id="to" style="width: 10%">
                                    部门：
                                    <s:select list="#getPrefixAction.copyRangeMap" cssClass="controls" cssStyle="width: 12%" name="copyrange"  id="department"  headerKey="-1" headerValue="全部" listkey="key" listvalue="value" />
                                    <button class="btn" type="button" onclick="SearchFileByTime()">查询</button>
                                    <button class="btn" type="button" onclick="window.open('exportFileInfo.jsp')">导出</button>
                                </div>
                            </div>
                        </div>
...
<!--ajax读取-->
<script src="js/fileSys/SearchFile.js"></script>
