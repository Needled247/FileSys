                ...
                <div class="box span12" style="">
                    ...
                    <div class="box-content">
                            <fieldset>
                                ...
                                <div class="control-group">
                                    <label class="control-label" for="fujian">附件：</label>
                                    <div class="controls">
                                        <span class="input-xlarge focused" id="fujian">
                                            <%
                                                if(bean.getATTURL().equals("")){
                                                    %>
                                               <h3><font color="red">没有附件</font></h3>
                                            <%
                                                }else{
                                                    %>
                                            <a href='down.jsp?attr=<%=bean.getATTURL()%>' target="_blank"><%=bean.getFUNAME()%></a>
                                            <%
                                                }
                                            %>
                                        </span>
                                ...
                                <div class="form-actions">
                                    <button type="button" class="btn btn-success" onclick="saveFile()" id="btn_save">
                                        <i class="icon-ok icon-white"></i>发布</button>
                                    <button type="button" class="btn btn-warning" onclick="window.open('toPrint.jsp?pid=<%=pid%>&add=<%=add%>');" id="btn_print">
                                        <i class="icon-print icon-white"></i>导出</button>
                                    <button type="button" class="btn btn-danger" onclick="delFile()" id="btn_del">
                                        <i class="icon-print icon-white"></i>删除</button>
                                    <button type="reset" class="btn btn-primary" id="btn_back" onclick="window.location.href='index.jsp'">
